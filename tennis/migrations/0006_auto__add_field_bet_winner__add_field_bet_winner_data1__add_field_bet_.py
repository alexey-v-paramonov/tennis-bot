...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'tennis_bet', 'winner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='won_bets', null=True, to=orm['tennis.Player']),
                      keep_default=False)

        # Adding field 'Bet.winner_data1'
        db.add_column(u'tennis_bet', 'winner_data1',
                      self.gf('jsonfield.fields.JSONField')(default={}, null=True),
                      keep_default=False)

        # Adding field 'Bet.winner_data2'
        db.add_column(u'tennis_bet', 'winner_data2',
                      self.gf('jsonfield.fields.JSONField')(default={}, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'tennis_bet', 'winner_id')

        # Deleting field 'Bet.winner_data1'
        db.delete_column(u'tennis_bet', 'winner_data1')

        # Deleting field 'Bet.winner_data2'
        db.delete_column(u'tennis_bet', 'winner_data2')
