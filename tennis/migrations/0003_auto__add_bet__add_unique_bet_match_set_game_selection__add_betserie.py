...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bet'
        db.create_table(u'tennis_bet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('serie', self.gf('django.db.models.fields.related.ForeignKey')(related_name='serie_bets', null=True, to=orm['tennis.BetSerie'])),
            ('serie_step', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('match', self.gf('django.db.models.fields.related.ForeignKey')(related_name='match_bets', to=orm['tennis.Match'])),
            ('set', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('game', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('selection', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
            ('ts_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'tennis', ['Bet'])

        # Adding unique constraint on 'Bet', fields ['match', 'set', 'game', 'selection']
        db.create_unique(u'tennis_bet', ['match_id', 'set', 'game', 'selection'])

        # Adding model 'BetSerie'
        db.create_table(u'tennis_betserie', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'tennis', ['BetSerie'])


    def backwards(self, orm):
        # Removing unique constraint on 'Bet', fields ['match', 'set', 'game', 'selection']
        db.delete_unique(u'tennis_bet', ['match_id', 'set', 'game', 'selection'])

        # Deleting model 'Bet'
        db.delete_table(u'tennis_bet')

        # Deleting model 'BetSerie'
        db.delete_table(u'tennis_betserie')
