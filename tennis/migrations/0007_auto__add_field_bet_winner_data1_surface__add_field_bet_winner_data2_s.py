...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bet.winner_data1_surface'
        db.add_column(u'tennis_bet', 'winner_data1_surface',
                      self.gf('jsonfield.fields.JSONField')(default={}, null=True),
                      keep_default=False)

        # Adding field 'Bet.winner_data2_surface'
        db.add_column(u'tennis_bet', 'winner_data2_surface',
                      self.gf('jsonfield.fields.JSONField')(default={}, null=True),
                      keep_default=False)

        # Adding field 'Bet.winner_data1_recent'
        db.add_column(u'tennis_bet', 'winner_data1_recent',
                      self.gf('jsonfield.fields.JSONField')(default={}, null=True),
                      keep_default=False)

        # Adding field 'Bet.winner_data2_recent'
        db.add_column(u'tennis_bet', 'winner_data2_recent',
                      self.gf('jsonfield.fields.JSONField')(default={}, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bet.winner_data1_surface'
        db.delete_column(u'tennis_bet', 'winner_data1_surface')

        # Deleting field 'Bet.winner_data2_surface'
        db.delete_column(u'tennis_bet', 'winner_data2_surface')

        # Deleting field 'Bet.winner_data1_recent'
        db.delete_column(u'tennis_bet', 'winner_data1_recent')

        # Deleting field 'Bet.winner_data2_recent'
        db.delete_column(u'tennis_bet', 'winner_data2_recent')
