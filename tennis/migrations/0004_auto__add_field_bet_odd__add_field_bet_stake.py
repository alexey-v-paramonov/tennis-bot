...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bet.odd'
        db.add_column(u'tennis_bet', 'odd',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, null=True),
                      keep_default=False)

        # Adding field 'Bet.stake'
        db.add_column(u'tennis_bet', 'stake',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bet.odd'
        db.delete_column(u'tennis_bet', 'odd')

        # Deleting field 'Bet.stake'
        db.delete_column(u'tennis_bet', 'stake')
